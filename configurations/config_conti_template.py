...
Settings = {
    ...
    "robot_model_path": "assets/continuums_robot.xml",
    "render_mode": "human",
    "seed" : 42,
    "device" : "cpu",
    ...
    "distance_reward" : 73,
    "energy_reward" : 0,       #in gymnaisum typically one thenth of distance_reward
    "in_range_reward" : 58,     #reward while staying in target range
    "goal_reward" : 219,        #reward after succesfull termination
    "joint_limit_reward" : 0,   #punishment if get close to joint limits
    ...
    "timesteps_per_env" : 500_000, #timesteps of steps per env, should be multiples of "eval_freq"
    #"n_train_envs" : 11,       #normally is adjusted to "PC" variable
    "truncated_distance_steps": 200,
